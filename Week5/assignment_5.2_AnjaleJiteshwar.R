...
#Filer all 4-berroom houses using filter() function
housing_df %>% filter(bedrooms==4)

#Filer all houses whose sale price < 500000 using filter() function
housing_df %>% filter(Sale_Price<500000)

#Filer all houses which are sold in 2006 and sale price is less than 500000 using filter() function
